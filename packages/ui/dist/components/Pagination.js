...
const PaginationPrevious = ({ className, ...props }) => (_jsxs(PaginationLink, { "aria-label": "Go to previous page", size: "md", className: cn("gap-1 pl-2.5", className), ...props, children: [_jsx(ChevronLeft, { className: "h-4 w-4" }), _jsx("span", { children: "Anterior" })] }));
PaginationPrevious.displayName = "PaginationPrevious";
const PaginationNext = ({ className, ...props }) => (_jsxs(PaginationLink, { "aria-label": "Go to next page", size: "md", className: cn("gap-1 pr-2.5", className), ...props, children: [_jsx("span", { children: "Pr\u00F3ximo" }), _jsx(ChevronRight, { className: "h-4 w-4" })] }));
