...
function createAgencyThemeColors(agencyTheme) {
    return {
...
export function ThemeProvider({ children, defaultAgencyTheme = null, enableDarkMode = true }) {
    const [theme, setTheme] = useState(defaultTheme);
    const [agencyTheme, setAgencyThemeState] = useState(defaultAgencyTheme);
    ...
    const setAgencyTheme = useCallback((newAgencyTheme) => {
    ...
    useEffect(() => {
        ...
        const prefersDark = enableDarkMode && (savedTheme === 'dark' ||
