...
export interface AuthConfig {
  ...
  refreshThreshold: number; // Minutes before token expiry to refresh
...
export interface AuthApiClient {
  login: (
    ...
    success: boolean;
    data?: { accessToken: string; refreshToken: string; user: Partial<User> };
    message?: string;
  }>;
  register: (
    data: RegisterData,
  ...
  logout: () => Promise<void>;
  get: (path: string) => { json: () => Promise<Partial<User>> };
