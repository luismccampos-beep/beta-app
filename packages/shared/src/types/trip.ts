...
export const AccommodationSchema = AccommodationBaseSchema.refine(
  (data) => {
...
export const TransportationSchema = TransportationBaseSchema.refine(
  (data) => {
...
export const TripFeedbackSchema = TripFeedbackBaseSchema.refine(
  (data) => {
...
export function validateTripFeedback(data: unknown): {
  success: boolean;
  data?: TripFeedback;
  errors?: string[];
} {
