export type NewsletterStatus = 'draft' | 'sending' | 'sent' | 'failed' | 'archived' | 'scheduled' | 'cancelled';
...
export type ConfirmKind = 'sendCampaign' | 'deleteCampaign' | 'deleteSubscriber' | 'bulkDelete' | 'bulkExport';
