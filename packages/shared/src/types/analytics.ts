// Analytics types shared across frontend and backend
// Based on frontend/src/types/analytics.ts
...
export type LogAnalyticsEvent = <T extends AnalyticsEventType>(
  type: T,
  name: string,
...
export interface MLModelMetrics {
  ...
  trainingDate: string;
  version: string;
  features: { scores: number[]; names: string[]; metadata: MLFeatureMetadata };
}
