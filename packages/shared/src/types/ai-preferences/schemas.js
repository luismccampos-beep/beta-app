...
export const SupportedCurrencySchema = z.enum([
    'EUR', 'USD', 'GBP', 'JPY', 'CAD', 'AUD', 'CHF', 'SEK', 'NOK', 'DKK', 'PLN', 'CZK',
    'BRL', 'MXN', 'ARS', 'CLP', 'COP', 'PEN', 'UYQ', 'VEB', 'CNY', 'INR', 'KRW', 'SGD',
    'HKD', 'TWD', 'THB', 'MYR', 'IDR', 'PHP', 'NZD', 'ZAR', 'RUB', 'TRY', 'AED', 'SAR',
    'ILS', 'EGP', 'NGN', 'GHS', 'MAD', 'TND', 'HUF', 'RON', 'BGN', 'HRK', 'ISK'
]);
