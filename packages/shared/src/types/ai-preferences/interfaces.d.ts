 ...
 */
export declare const BUDGET_RANGE_CONFIGS: Record<BudgetLevel, BudgetRangeConfig>;
export type SupportedCurrency = 'EUR' | 'USD' | 'GBP' | 'JPY' | 'CAD' | 'AUD' | 'CHF' | 'SEK' | 'NOK' | 'DKK' | 'PLN' | 'CZK';
