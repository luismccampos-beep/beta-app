...
export const createSystemPaymentMethod = (overrides: Partial<SystemPaymentMethod> = {}): SystemPaymentMethod => {
  return {
...
export const createManySystemPaymentMethods = (count: number): SystemPaymentMethod[] => {
