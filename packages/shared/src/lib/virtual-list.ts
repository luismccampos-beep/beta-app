...
const availableExports: Record<string, unknown> = {};

if (reactWindow.FixedSizeList) {
  (availableExports as { FixedSizeList: unknown }).FixedSizeList = reactWindow.FixedSizeList;
}
if (reactWindow.VariableSizeList) {
  (availableExports as { VariableSizeList: unknown }).VariableSizeList = reactWindow.VariableSizeList;
}
