...
export const DashboardCard: React.FC<DashboardCardProps> = ({
  ...
  const getTrendColor = (t: 'up' | 'down' | 'neutral' | undefined) => {
    switch (t) {
  ...
  return (
    ...
    >
      {/* Background Gradient */}
      <div className={`absolute top-0 right-0 w-32 h-32 -mr-8 -mt-8 bg-gradient-to-br ${config.bg} rounded-full blur-3xl opacity-50`} />

      <div className="relative flex flex-col h-full">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          <div className={cn('p-3 rounded-xl', config.iconBg, config.text)}>
        ...
        <div className="mt-auto">
          ...
          <div className="flex items-baseline gap-2 mt-1">
            ...
            {currentChange && (
              <div className={cn('flex items-center gap-0.5 px-2 py-0.5 rounded-full text-xs font-bold', getTrendColor(currentTrend))}>
              ...
              <div
                ...
                className={cn(
                  ...
                  action.variant === 'outline'
                    ...
                    : `bg-gradient-to-r ${config.gradient} text-white shadow-sm hover:opacity-90`
                )}
              >
                {action.label}
              </div>
