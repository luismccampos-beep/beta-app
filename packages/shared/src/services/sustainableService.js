...
export const sustainableService = {
    ...
    async getDestinations() {
        try {
            const resp = await apiClient.get('/sustainable/destinations');
    ...
    async getDestinationById(id) {
        try {
            ...
            const resp = await apiClient.get(`/sustainable/destinations/${encodeURIComponent(sanitizedId)}`);
    ...
    async computeFootprint(segments) {
        try {
            const resp = await apiClient.post('/sustainable/calculate', { segments });
            return resp;
        }
        catch (error) {
...
//# sourceMappingURL=sustainableService.js.map