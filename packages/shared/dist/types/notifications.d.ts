 ...
 */
export type UINotificationItem = Pick<NotificationData, 'id' | 'title' | 'message' | 'kind' | 'priority' | 'status' | 'createdAt' | 'actionUrl'>;
/**
 ...
 */
export declare const PRIORITY_WEIGHT: Record<NotificationPriority, number>;
/**
 ...
 */
export declare const sortNotificationsByPriority: (a: UINotificationItem, b: UINotificationItem) => number;
