...
export type ServiceCategory = 'accommodation' | 'transportation' | 'activities' | 'dining' | 'insurance' | 'guides' | 'equipment';
...
export type PackageCategory = 'adventure' | 'luxury' | 'family' | 'romantic' | 'cultural' | 'eco' | 'coastal' | 'corporate' | 'cultural-exchange' | 'gastronomic' | 'group-travel' | 'photography' | 'snow-sports' | 'wellness' | string;
