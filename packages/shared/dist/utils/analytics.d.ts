...
export type GtagFunction = (command: GtagAction['command'], action: string | Date, params?: GtagEventParams | GtagConfigParams | GtagConsentParams | string | boolean | number) => void;
declare global {
    interface Window {
        gtag?: GtagFunction;
    }
}
export declare function trackGtagEvent(action: string, category: string, label?: string, value?: number): void;
