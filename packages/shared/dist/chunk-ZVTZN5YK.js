// src/types/trip.ts
import { z } from "zod";
var ActivityBaseSchema = z.object({
  id: z.string().uuid(),
...
var ActivitySchema = ActivityBaseSchema.refine(
  (data) => {
...
var AccommodationBaseSchema = z.object({
  id: z.string().uuid(),
  name: z.string().min(1, "Name is required"),
...
var AccommodationSchema = AccommodationBaseSchema.refine(
  (data) => {
...
var TransportationBaseSchema = z.object({
  id: z.string().uuid(),
...
var TransportationSchema = TransportationBaseSchema.refine(
  (data) => {
...
var TripFeedbackBaseSchema = z.object({
...
var TripFeedbackSchema = TripFeedbackBaseSchema.refine(
  (data) => {
...
function validateTripFeedback(data) {
...
var ActivitySchemaForFeedback = ActivityBaseSchema.partial();
var AccommodationSchemaForFeedback = AccommodationBaseSchema.partial();
var TransportationSchemaForFeedback = TransportationBaseSchema.partial();
...
//# sourceMappingURL=chunk-ZVTZN5YK.js.map