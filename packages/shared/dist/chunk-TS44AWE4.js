...
var LanguageSwitcher = ({
  ...
  if (!Button || !DropdownMenu || !DropdownMenuContent || !DropdownMenuItem || !DropdownMenuTrigger) {
    return /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-2 ${className}` }, /* @__PURE__ */ React.createElement(Icon, { className: getIconSize(size) }), showLabel && /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium" }, currentLanguage.name));
  }
  return /* @__PURE__ */ React.createElement(DropdownMenu, null, /* @__PURE__ */ React.createElement(DropdownMenuTrigger, { asChild: true }, /* @__PURE__ */ React.createElement(
    ...
    showLabel && /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium" }, currentLanguage.name),
    currentLanguage.flag && /* @__PURE__ */ React.createElement("span", null, currentLanguage.flag)
  )), /* @__PURE__ */ React.createElement(DropdownMenuContent, { align: "end", className: "w-48" }, supportedLanguages.map((language) => /* @__PURE__ */ React.createElement(
    DropdownMenuItem,
    {
      key: language.code,
    ...
    /* @__PURE__ */ React.createElement("span", null, language.flag),
    /* @__PURE__ */ React.createElement("span", { className: "flex-1" }, language.name),
    language.code === currentLanguage.code && /* @__PURE__ */ React.createElement(Check, { className: "h-4 w-4 text-primary" })
  ))));
};
...
//# sourceMappingURL=chunk-TS44AWE4.js.map