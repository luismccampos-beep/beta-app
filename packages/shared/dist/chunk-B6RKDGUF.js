...
var Button = React.forwardRef(
  ({
    ...
    const content = isLoading ? /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin text-current" }) : /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2", children: [
...
//# sourceMappingURL=chunk-B6RKDGUF.js.map