...
- [SCHEMA_REFACTORING_PHASE2.md](./SCHEMA_REFACTORING_PHASE2.md) — phase 2 objectives following these migrations
- [TRAVEL-INTELLIGENCE-SCHEMA.md](./TRAVEL-INTELLIGENCE-SCHEMA.md) — target schema design this migration works toward
- [AUDIT-AKMLEVA.md](./AUDIT-AKMLEVA.md) — audit that identified the issues driving these migrations
- [Auditoria-2.md](./Auditoria-2.md) — second audit with additional migration inputs
