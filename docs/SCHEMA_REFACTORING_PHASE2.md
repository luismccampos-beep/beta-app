...
- [SCHEMA_MIGRATION_PLAN.md](./SCHEMA_MIGRATION_PLAN.md) — phase 1 migrations that precede this refactoring
- [TRAVEL-INTELLIGENCE-SCHEMA.md](./TRAVEL-INTELLIGENCE-SCHEMA.md) — target schema architecture
- [AUDIT-AKMLEVA.md](./AUDIT-AKMLEVA.md) — audit findings driving this refactoring
