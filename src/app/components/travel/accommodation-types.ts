...
export const ACCOMMODATION_COLORS: Record<string, string> = {
  ...
  pousada: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300',
  ...
  hotel: 'bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300',
};
