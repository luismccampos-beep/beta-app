        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-16">
          ...
          <Card className="border-2 border-purple-200 dark:border-purple-700 shadow-xl dark:bg-gray-800 hover:scale-105 transition-transform">
            <CardContent className="p-4 sm:p-6 text-center">
              ...
              <a href="mailto:info@akmleva.com" className="text-xs sm:text-sm text-teal-600 dark:text-teal-400 hover:underline">info@akmleva.com</a>
            </CardContent>
          </Card>
            ...
            <Card className="border-2 border-gray-200 dark:border-gray-700 shadow-xl dark:bg-gray-800">
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a href="https://facebook.com/akmleva" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors">
                  ...
                  <a href="https://instagram.com/akmleva" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-pink-50 dark:bg-pink-900/20 hover:bg-pink-100 dark:hover:bg-pink-900/40 transition-colors">
                  ...
                  <a href="https://linkedin.com/company/akmleva" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors">
