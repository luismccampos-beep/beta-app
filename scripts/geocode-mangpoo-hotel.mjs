...
async function gmapsGeocode(query) {
  try {
    ...
    console.log(`    GMaps results: ${results.length} places found`);
    for (const place of results) {
      console.log(`      - ${place.name}: ${place.coordinates?.latitude}, ${place.coordinates?.longitude}`);
