      ...
      <div className="rounded-2xl border-2 border-primary-200 dark:border-primary-700 bg-white dark:bg-gray-800 shadow-xl overflow-hidden">
        ...
        <div className="p-5 sm:p-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{t('terms.title')}</h2>
          </div>
          <div className="flex flex-wrap items-center gap-3 mb-5">
            <span className="inline-flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-400">
              <Calendar className="w-4 h-4 text-primary dark:text-primary-300" />
              <span className="font-medium">{t('terms.lastUpdated')}</span>
            </span>
          ...
          <div className="p-4 sm:p-5 bg-primary-50 dark:bg-primary-900/20 border-l-4 border-primary rounded-lg">
            <p className="text-sm sm:text-base text-gray-900 dark:text-gray-200 leading-relaxed">{t('terms.intro')}</p>
          </div>
        </div>
      </div>
      ...
      <AnimatedSection>
        <div className="rounded-2xl bg-gradient-to-r from-primary to-accent text-white shadow-xl p-5 sm:p-7">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-bold mb-1.5">{t('terms.governingTitle') || 'Governing Law'}</h3>
              <p className="text-sm sm:text-base text-white/90 leading-relaxed">{t('terms.governing')}</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection>
        <div className="rounded-2xl bg-gradient-to-r from-primary to-accent text-white shadow-xl p-5 sm:p-7">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-bold mb-1.5">{t('privacy.commitmentTitle') || 'Our Commitment'}</h3>
              <p className="text-sm sm:text-base text-white/90 leading-relaxed">{t('privacy.commitment')}</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
