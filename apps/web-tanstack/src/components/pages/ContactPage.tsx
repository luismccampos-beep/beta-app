...
import { useContactTranslations } from '@/lib/i18n-namespaces';
import {
  MapPin,
  Phone,
  Mail,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 relative z-10">
        ...
        >
          {[
            ...
            { icon: Phone, title: t('phoneTitle'), val: '+351 256 372 092', valHref: 'tel:+351256372092', color: 'from-primary to-primary-700' },
            { icon: Mail, title: t('emailTitle'), val: 'geral@akmleva.pt', valHref: 'mailto:geral@akmleva.pt', color: 'from-accent to-accent-700' },
              ...
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {[
                    ...
                    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/akmleva-travel-agency-a772373a6/', icon: 'M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z', color: 'text-primary bg-primary-700/10 border-primary-700/20' },
