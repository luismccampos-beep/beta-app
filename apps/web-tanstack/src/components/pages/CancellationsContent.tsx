  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeInUp} className="mb-8 p-6 bg-accent-50 dark:bg-accent-700/20 border-l-4 border-accent rounded-lg">
        <p className="font-semibold text-lg text-accent-700 dark:text-accent-200 mb-2">{t('cancellations.warningTitle')}</p>
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">{t('cancellations.warningText')}</p>
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{t('cancellations.section1Title')}</h2>
      </motion.div>
        ...
        <motion.li variants={fadeInUp} whileHover={{ x: 3 }} className="flex items-start gap-2">
          ...
          <span>{t('cancellations.section1a')}</span>
        </motion.li>
        <motion.li variants={fadeInUp} whileHover={{ x: 3 }} className="flex items-start gap-2">
          <CheckCircle2 className="w-4 h-4 text-primary-700 dark:text-primary-300 mt-0.5 flex-shrink-0" />
          <span>{t('cancellations.section1b')}</span>
        </motion.li>
        <motion.li variants={fadeInUp} whileHover={{ x: 3 }} className="flex items-start gap-2">
          <CheckCircle2 className="w-4 h-4 text-primary-700 dark:text-primary-300 mt-0.5 flex-shrink-0" />
          <span>{t('cancellations.section1c')}</span>
        </motion.li>
      </motion.ul>
      ...
      <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-4 mt-8">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{t('cancellations.section2Title')}</h2>
      </motion.div>
      <motion.div variants={fadeInUp} className="overflow-x-auto my-4">
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-800">
              <th className="border border-gray-300 dark:border-gray-600 p-3 text-left">{t('cancellations.tablePeriod')}</th>
              <th className="border border-gray-300 dark:border-gray-600 p-3 text-left">{t('cancellations.tableFee')}</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-gray-300 dark:border-gray-600 p-3">{t('cancellations.period30')}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-3 font-semibold text-green-700 dark:text-green-400">{t('cancellations.fee30')}</td>
            </tr>
            <tr className="bg-gray-50 dark:bg-gray-900/50">
              <td className="border border-gray-300 dark:border-gray-600 p-3">{t('cancellations.period15')}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-3 font-semibold text-accent-700 dark:text-accent-500">{t('cancellations.fee15')}</td>
            </tr>
            <tr>
              <td className="border border-gray-300 dark:border-gray-600 p-3">{t('cancellations.period14')}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-3 font-semibold text-red-700 dark:text-red-400">{t('cancellations.fee14')}</td>
            </tr>
          </tbody>
        </table>
      </motion.div>
      ...
      <motion.div variants={staggerContainer} className="my-4 space-y-3">
        <motion.div variants={fadeInUp} whileHover={{ x: 4 }} className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20 rounded-r">
          <p className="font-semibold">{t('cancellations.section2a')}</p>
        </motion.div>
        <motion.div variants={fadeInUp} whileHover={{ x: 4 }} className="p-4 border-l-4 border-accent bg-accent-50 dark:bg-accent-700/20 rounded-r">
          <p className="font-semibold">{t('cancellations.section2b')}</p>
        </motion.div>
        <motion.div variants={fadeInUp} whileHover={{ x: 4 }} className="p-4 border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20 rounded-r">
          <p className="font-semibold">{t('cancellations.section2c')}</p>
        </motion.div>
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-4 mt-8">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{t('cancellations.section4Title')}</h2>
      </motion.div>
      <motion.p variants={fadeInUp} className="mb-4">{t('cancellations.section4Intro')}</motion.p>
        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-lg mb-1">{t(`cancellations.step${i}Title`)}</h3>
              <p className="text-sm text-gray-700 dark:text-gray-300">{t(`cancellations.step${i}Desc`)}</p>
            </div>
          </motion.div>
        ))}
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="my-6 p-6 bg-primary-50 dark:bg-primary-900/20 border-2 border-primary-300 dark:border-primary-700 rounded-lg text-center">
        ...
        <p className="font-semibold text-lg text-primary-900 dark:text-primary-200">{t('cancellations.ctaTitle')}</p>
        <p className="text-sm text-primary-700 dark:text-primary-300 mt-1">{t('cancellations.ctaDesc')}</p>
      </motion.div>
      ...
      <motion.p variants={fadeInUp} className="mb-4">{t('cancellations.section5Intro')}</motion.p>
        ...
        {[1, 2, 3].map((i) => (
          <motion.details key={i} variants={fadeInUp} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <summary className="font-semibold cursor-pointer flex items-center gap-2">
              <span className="text-primary-700 dark:text-primary-300">{i}.</span> {t(`cancellations.faq${i}Question`)}
            </summary>
            <p className="text-sm mt-3 text-gray-700 dark:text-gray-300 pl-6">{t(`cancellations.faq${i}Answer`)}</p>
          </motion.details>
        ))}
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="my-6 p-4 bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-400 dark:border-gray-600 rounded-r">
        <p className="text-sm text-gray-700 dark:text-gray-300 italic">{t('cancellations.faqFallback')}</p>
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        <p className="text-xs text-gray-600 dark:text-gray-400"><strong>{t('cancellations.lastUpdated')}</strong></p>
      </motion.div>
    </motion.div>
  );
}
