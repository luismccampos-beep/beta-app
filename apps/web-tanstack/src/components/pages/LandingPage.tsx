...
import { useLandingTranslations } from '@/lib/i18n-namespaces';
    ...
    <motion.div variants={fadeInUp}>
      ...
      >
        ...
        <div className="text-center group p-8 glass bg-gradient-to-br from-green-600/30 to-orange-600/30 dark:from-green-500/20 dark:to-orange-500/20 border-white/10 dark:border-white/5 rounded-3xl hover:from-green-600/40 hover:to-orange-600/40 dark:hover:from-green-500/30 dark:hover:to-orange-500/30 transition-all duration-500">
          <Icon className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-8 group-hover:scale-110 transition-all duration-500" />
          <div className="text-4xl sm:text-6xl md:text-7xl font-black text-white mb-4 tracking-tighter">
            <Counter end={value} suffix={suffix} duration={3} />
          </div>
          <div className="text-lg sm:text-2xl font-bold text-white mb-2">{label}</div>
          <div className="text-xs sm:text-sm text-white/60 font-medium uppercase tracking-widest">{sub}</div>
        </div>
      </motion.div>
    </motion.div>
  );
...
function AnimatedTitle({ text }: { text: string }) {
  ...
  return (
    <motion.h2
      className="text-4xl sm:text-5xl md:text-8xl lg:text-9xl font-black text-gray-900 dark:text-white leading-[1.1] tracking-tighter text-balance overflow-visible"
      aria-label={text}
    >
      {words.map((word, wi) => (
...
export function LandingPage({ onGetStarted }: LandingPageProps) {
  ...
  const goDashboard = useCallback(() => navigate({ to: '/dashboard' }), [navigate]);
    ...
    <div className="min-h-screen selection:bg-primary/20">
        ...
        >
          <div className="text-center space-y-12">
            ...
            {/* Description */}              <motion.p
              variants={fadeInUp}
              className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed text-pretty font-medium"
            >
              {t('heroDesc')}
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="w-full max-w-3xl mx-auto space-y-6">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <RippleButton
                  ...
                  size="lg"
                  magneticDistance={4}
                  className="gap-2 sm:gap-3 text-lg sm:text-2xl px-6 sm:px-10 py-4 sm:py-5 h-auto shadow-glow-primary hover:shadow-glow-accent transition-all group whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isGenerating ? (
                    <>
                      <motion.div
            ...
            <motion.div variants={fadeInUp}>
              <RippleButton
                ...
                size="lg"
                magneticDistance={4}
                className="gap-2 sm:gap-3 text-lg sm:text-xl px-6 sm:px-8 py-3 sm:py-4 h-auto border-primary-300 dark:border-gray-700 hover:bg-primary-50 dark:hover:bg-gray-800 dark:text-gray-100 group glass"
              >
                {t('getStarted')}
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-50 via-cyan-50 to-accent-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-primary-100 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 rounded-full px-4 sm:px-6 py-2 mb-6">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-accent" />
              <span className="text-xs sm:text-sm font-bold text-primary-800 dark:text-primary-200 uppercase tracking-widest">
                {t('sandboxTitle') || 'Experimente grátis'}
              </span>
            </div>
            <h3 className="text-3xl sm:text-4xl md:text-6xl font-black text-gray-900 dark:text-white mb-8 tracking-tighter uppercase">
              {t('visualPreview')}
            </h3>
            <p className="text-lg sm:text-2xl lg:text-3xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto font-medium leading-relaxed">
              {t('visualPreviewDesc')}
            </p>
          </motion.div>
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-800 to-accent-800 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <h3 className="text-3xl sm:text-5xl md:text-6xl font-black text-white mb-8 tracking-tighter uppercase">
              {t('stats')}
            </h3>
            <p className="text-lg sm:text-2xl text-white/80 max-w-2xl mx-auto font-medium italic">
      ...
      <section className="relative py-40 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-50 via-cyan-50 to-accent-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors overflow-hidden">
        ...
        >
          ...
          <p className="text-lg sm:text-2xl md:text-3xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed font-semibold">
            {t('ctaDesc')}
          </p>
          ...
          <div className="flex flex-col items-center gap-12">
            <RippleButton
              ...
              size="lg"
              magneticDistance={5}
              className="gap-3 sm:gap-5 text-xl sm:text-3xl px-10 sm:px-20 py-8 sm:py-12 h-auto shadow-glow-primary hover:shadow-glow-accent hover:scale-110 transition-all group font-black rounded-2xl"
            >
              <Sparkles className="w-7 h-7 sm:w-10 sm:h-10 animate-float" />
              {t('startYourJourney')}
              <ArrowRight className="w-7 h-7 sm:w-10 sm:h-10 transition-transform group-hover:translate-x-4" />
            </RippleButton>

            <div className="flex items-center justify-center gap-6 sm:gap-12 flex-wrap opacity-60 dark:opacity-40">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base font-black uppercase tracking-tighter text-gray-950 dark:text-white"
                >
