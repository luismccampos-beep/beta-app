            ...
            <>
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  {CRUISE_DESTINATION_IDS.map((id: string) => (
                    <div
                      key={id}
                    className="flex items-center space-x-2 bg-gray-50 dark:bg-gray-800 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors touch-manipulation"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <SelectContent>
                      {CRUISE_SHIP_TYPE_IDS.map((id: string) => (
                        <SelectItem key={id} value={id}>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {CRUISE_DURATION_IDS.map((id: string) => (
                    <button
                      key={id}
                      type="button"
              ...
              <div className="space-y-3">
                ...
                {travelCatalogLoading ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 max-h-64 overflow-y-auto overscroll-y-contain pr-1">
                    {travelCatalog!.cruiseBrands!.map((brand: { name: string; tier: string; label: string; shipCount: number }) => (
                      <div
                        key={brand.name}
                        className="flex items-center space-x-2 bg-gray-50 dark:bg-gray-800 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors touch-manipulation"
                      >
