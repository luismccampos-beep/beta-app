...
const getTravelStylesData = (t: (key: string) => string) => [
  { id: 'luxury', label: t('luxury'), emoji: '\u{1F451}', color: 'from-yellow-500 to-amber-600' },
...
const PURPOSE_EMOJIS: Record<string, string> = {
  business: '\u{1F4BC}', leisure: '\u{1F334}', conference: '\u{1F91D}', family: '\u{1F468}\u200D\u{1F469}\u200D\u{1F467}',
};
      ...
      <div className="space-y-3">
        ...
        <Controller name="travelFrequency" control={control} render={({ field }) => (
          <Select value={field.value} onValueChange={field.onChange}>
            ...
            <SelectContent>
              {TRAVEL_FREQUENCY_IDS.map((id: string) => (
              ...
              <PopoverContent className="p-0 w-[--radix-popover-trigger-width]" align="start">
                <Command>
                  ...
                  <CommandList>
                    ...
                    <CommandGroup>
                      {travelCatalog!.airports.map((a: { iataCode: string; label: string; country: string | null }) => (
