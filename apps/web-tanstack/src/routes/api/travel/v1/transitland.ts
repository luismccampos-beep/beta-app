...
export const Route = createFileRoute('/api/travel/v1/transitland')({
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        switch (params.action) {
          case 'routing': {
            ...
            return Response.json({ ok: true, configured: true, plans: result.plans })
          }
          ...
          case 'operators': {
            ...
            return Response.json({ ok: true, configured: true, operators })
          }
          ...
          case 'stops': {
            ...
            return Response.json({ ok: true, configured: true, stops })
          }
        }
      },
    },
